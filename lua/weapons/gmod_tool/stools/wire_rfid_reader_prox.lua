...
function TOOL:LeftClick( trace )
	...
	if ( trace.Entity:IsValid() and trace.Entity:GetClass() == "gmod_wire_rfid_reader_prox" and trace.Entity:GetTable().pl == ply ) then
...
function TOOL:UpdateGhostWireReader( ent, player )
	...
	if (!trace.Hit or trace.Entity:IsPlayer() or trace.Entity:GetClass() == "gmod_wire_rfid_reader_prox" ) then
		ent:SetNoDraw( true )
		return
	end
