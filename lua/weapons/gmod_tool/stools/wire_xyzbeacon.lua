...
function TOOL:LeftClick( trace )
	...
	if ( trace.Entity:IsValid() and trace.Entity:GetClass() == "gmod_wire_xyzbeacon" and trace.Entity:GetTable().pl == ply ) then
		return true
	end
...
function TOOL:UpdateGhostWireXYZBeacon( ent, player )
	...
	if (!trace.Hit or trace.Entity:IsPlayer() or trace.Entity:GetClass() == "gmod_wire_xyzbeacon" ) then
		ent:SetNoDraw( true )
		return
	end
